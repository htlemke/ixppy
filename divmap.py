...
def getCmapData(RGB1=np.array([59, 76, 192]),RGB2=np.array([180, 4, 38]),numColors=255.,divide = 255.):
  cmc = ColorMapCreator(RGB1, RGB2, numColors=numColors, divide=255.)
  return cmc.colorMapReturnData

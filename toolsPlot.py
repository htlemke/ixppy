...
#def subplots(*args,**kwargs):
    ...
    #fig = nfigure(name)
#
    #return plt.subplots(num=fig.number,*args,**kwargs)
  #else:
...
def xlabel_append(strng,ax=None):
  if ax is None:
    ax = plt.gca()
  ax.set_xlabel(ax.get_xlabel()+strng)
  plt.draw_if_interactive()

def ylabel_append(strng,ax=None):
  if ax is None:
    ax = plt.gca()
  ax.set_ylabel(ax.get_ylabel()+strng)
  plt.draw_if_interactive()
